...
const BLOG = {
  AUTHOR: 'gcooter', // 作者
  BIO: 'gcoo.io', // 作者简介
  LINK: 'https://blog.gcoo.io', // 网站地址
  KEYWORDS: 'gcooter,gcoo,지쿠터', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'fd341e1fc73b42ee9a5b4ef20dc4a909', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  LANG: 'ko-KR', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  FONT: 'font-sans', // 文章字体 ['font-sans', 'font-serif', 'font-mono'] @see https://www.tailwindcss.cn/docs/font-family
  FONT_AWESOME_PATH:
  ...
  BACKGROUND_DARK: '#fffff', // use hex value, don't forget '#'
  ...
  CONTACT_EMAIL: 'kkobi.kim@gbike.io',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-TDG3NTZ6M4', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'blog.gcoo.io', // 站点描述，被notion中的页面描述覆盖
